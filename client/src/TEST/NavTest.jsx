...
export default function Navigation() {
    return (
        <>
            <header className="fixed top-0 left-0 w-full z-50 border-b border-b-gray-200 py-3 px5">
                <div className="bg-[rgb(var(--bg-white-72))] max-w-[1120px] m-auto flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <span>
                            <p className="m-0 display-font font-bold tracking-tighter text-lg">Lyncks</p>
                        </span>
                    </div>
                    <nav className="flex gap-3 font-semibold display-font">
