                ...
                <div className="max-w-[700px] my-0 mx-auto py-0 px-[32px] w-full">
                    <div className="flex justify-center bg-[oklch(98.5%_0.002_247.839)] px-[35px] py-[40px] rounded-2xl">
                        <div>
                            ...
                            <div className="flex justify-center items-center border border-gray-200  h-15 gap-2 rounded-lg mt-10 cursor-pointer whitespace-nowrap px-3" onClick={handleLogin}>

                                <svg className="w-[clamp(20px,2vw,30px)]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
                            ...
                            <div className=" rounded-md mt-10 text-[clamp(12px,2vw,16px)]" >
                                ...
                                <div className="flex items-center gap-2  mt-2">
                                    ...
                                    <p className="m-0 text-black/50">One secure account for everything</p>
                                </div>

                                <div className="flex items-center gap-2 ">
                                    <i className="bi bi-check2 text-[oklch(79.2%_0.209_151.711)]"></i>
                                    <p className="m-0 text-black/50">No passwords to remember or reset</p>
                                </div>

                                <div className="flex items-center gap-2 ">
                                    <i className="bi bi-check2 text-[oklch(79.2%_0.209_151.711)]"></i>
                                    <p className="m-0 text-black/50">Fast setup, instant access</p>
                                </div>

                            </div>

                            <div className="rounded-md mt-5 text-[clamp(12px,2vw,16px)]">
                                <p className="m-0 font-bold">Your privacy matters</p>

                                <div className="flex items-center gap-2  mt-2">
                                    <i className="bi bi-check2 text-[oklch(79.2%_0.209_151.711)]"></i>
                                    <p className="m-0 text-black/50">We only access your name and email</p>
                                </div>

                                <div className="flex items-center gap-2 ">
                                    <i className="bi bi-check2 text-[oklch(79.2%_0.209_151.711)]"></i>
                                    <p className="m-0 text-black/50">No password database to worry about</p>
                                </div>

                                <div className="flex items-center gap-2 ">
                                    <i className="bi bi-check2 text-[oklch(79.2%_0.209_151.711)]"></i>
                                    <p className="m-0 text-black/50">Encrypted by Google's security</p>
                                </div>
                            </div>
                        </div>
                    </div>
