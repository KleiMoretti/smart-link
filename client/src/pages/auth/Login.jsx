    ...
    return (
        <>
            <section className="px-3 py-3 h-screen relative overflow-hidden min-h-[300px] min-w-[200px]">
                ...
                <div className="flex justify-center">
                    <div className="flex gap-2 justify-start items-center w-1/6 mt-3 p-3 cursor-pointer border border-gray-400 hover:bg-gray-100 rounded-lg" onClick={handleLogin}>
                        <div className="flex justify-start items-center">
                            <i className="bi bi-google"></i>
                        </div>
                        <div className="flex justify-start items-center">
                            <p className="m-0">Continue With Google Account</p>
                        </div>
                    </div>
                </div>
