    ...
    return (
        <section className="lg:py-[140px] py-40 px-2 lg:px-0  w-full lg:flex justify-center items-center bg-gray-100 min-h-screen ">
            <div className="lg:w-1/2 w-full">
                <p className="font-semibold text-[clamp(12px,2vw,18px)] whitespace-nowrap">Hello! I'm Moretti AI. What are we organizing today?</p>
                <div className="bg-white px-4 py-3 rounded-full flex w-full">
                    <input type="text"
                        ...
                        className="outline-none w-full placeholder:text-sm lg:placeholder:text-lg"
                        value={prompt}
