...
export default function AI_TEST() {
    ...
    return (
        ...
        <section className="lg:py-[140px] py-8 px-2 lg:px-0 w-full flex lg:flex-row flex-col lg:justify-center lg:items-center overflow-hidden justify-end items-end min-h-[100dvh] ">
