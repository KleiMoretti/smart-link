...
export default function Contact() {
    ...
    return (
        <>
            <section id="contact" className="contact relative pt-[120px] pb-[100px] px-0">
                <div className="max-w-[1120px] my-0 mx-auto py-0 px-[32px] grid lg:grid-cols-[1fr_1fr] gap-[64px]">
                    ...
                    <div className="contact__info">
                        ...
                        <p className="text-[clamp(26px,3.6vw,38px)] font-bold font-['Space_Grotesk',sans-serif] leading-[1.3] tracking-[-0.01em] max-w-[720px]">Collaboration & Partnerships</p>
                        <div className="mb-[60px]">
                            <p className="text-[15px] leading-[1.65] text-[#94a3b8] max-w-[420px]">Interested in growing together? Share your vision with us, and let's explore how we can create meaningful partnerships that drive results.</p>
                        </div>
                    ...
                    <div className="contact__send">
                        <form className="flex flex-col gap-[18px] bg-[#141d35] border-2 border-[#22304f] p-[28px] rounded-lg">
                            <label className="flex flex-col gap-[8px] text-[13px] text-[#94a3b8]">
                                <p>Name</p>
                                <input className=" w-full font-['Inter',sans-serif] text-[14px] text-[#f8fafc] bg-[#111a2e] border-2 border-[#22304f] rounded-lg py-[12px] px-[14px] resize-none transition-colors duration-200 ease-in-out"
                            ...
                            <label className="flex flex-col gap-[8px] text-[13px] text-[#94a3b8]">
                                ...
                                <textarea className="max-h-[150px] min-h-[150px] outline-none w-full font-['Inter',sans-serif] text-[14px] text-[#f8fafc] bg-[#111a2e] border-1 border-[#22304f] rounded-lg py-[12px] px-[14px] resize-none transition-colors duration-200 ease-in-out"
                                    type="text" placeholder="3 classes a day, Gmeet + Zoom..." />
                            </label>
